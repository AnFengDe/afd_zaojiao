...
<div class="item-cell">
  ...
  <input :style="{border:border_width,borderColor:border_color,backgroundColor:background_color}" class="input-cell" :disabled=currentState :placeholder=placeholder_text type="tel" @blur="check(this)" v-model="currentValue"/>
</div>
</template>
<script>
export default {
  ...
  props: ["title", "value", "disabled", "placeholder", "hint", "options", "min", "max"],
  computed: {
    currentValue: {
