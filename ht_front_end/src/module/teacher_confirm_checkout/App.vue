...
<div id="app">
  <div v-if="is_success">
    ...
    <div style="padding:13px;">
      ...
      <div class="button" @click="check">确认签退</div>
    </div>
  </div>
  <item_check_result v-else success_title="成功签退" :child_name="this.result.child" :check_time="this.result.datetime" :operater="this.result.operate"></item_check_result>
</div>
</template>
